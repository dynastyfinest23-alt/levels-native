...
export const FALLBACK_COPY: Record<string, DashboardCopy> = {
  ...
  contracted: {
    ...
    hidden_benefit:
      "The gripping has kept you vigilant. Fear of losing has protected what little felt securable, and wanting has at least kept a direction alive.",
    illusion:
  ...
  reactive: {
    ...
    hidden_benefit:
      "The heat is real fuel. Anger got you moving when nothing else did, and pride built a self worth defending. That force brought you this far.",
    illusion:
  ...
  threshold: {
    ...
    hidden_benefit:
      "Contentment has been earned ground. It gave you rest after the climb below it, and courage here doesn't announce itself — it just keeps showing up.",
    illusion:
  ...
  builder: {
    ...
    hidden_benefit:
      "Willingness compounds. The neutrality you've reached isn't detachment — it's the steadiness that lets you act without needing the outcome to soothe you.",
    illusion:
